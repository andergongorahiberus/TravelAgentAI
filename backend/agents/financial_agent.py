...
from tools.flight_search_tool_online import search_flights_online
from tools.hotel_search_tool_online import search_hotels_online
...
def create_financial_agent():
    return Agent(
        ...
        tools=[search_flights_online, search_hotels_online],
